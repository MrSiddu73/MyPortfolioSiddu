...
/**
 * Project detail page with hero image, technologies, and links
 * Features smooth animations and project information
 */
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-2">
                {project.technologies.map((tech) => (
                  <span
                    key={tech}
                    className="px-3 py-1 text-sm font-light bg-accent rounded-full"
                  >
                    {tech}
                  </span>
                ))}
